<%-- 
    Document   : insertarHilo
    Created on : 25-nov-2012, 14:03:01
    Author     : Laur
--%>
...
<html>
        ...
        <script>
            ...
            function valida(F) {  
                ...
                if( vacio(F.nombre.value) == false ) {  
                    alert("Debes poner un título para el Foro.")  
                    return false  
                } else {
                    return true  
                }
    ...
    <body>   
        ...
        <div id="cuerpo2" class="span3">
            <fieldset>
                <div>
                    <legend>  Añade un tema al Foro </legend>
                    <form action="Nuevo" method="post" onSubmit="return valida(this);"> 
                        ...
                        <input type="submit" value="Añadir foro" class="float"/>
                    </form>
