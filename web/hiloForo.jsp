<%-- 
    Document   : sesion
    Created on : 06-nov-2012, 19:42:56
    Author     : Laur
--%>


<%@page import="Pojos.POJOTipoUsuario"%>
...
<%
    ...
    int tipo_usuario = id.getIdTipoUsuario();

    /* Recogemos los atributos del pojo para usarlos */
    LinkedList<POJOHilo> registros = (LinkedList) request.getAttribute("datos");
    int size = registros.size();

    /* Añadimos la variable para buscar */
    String busqueda = "";
...
<html>
    <head>
        ...
        <script>
            ...
            {
                if(confirm('¿Estas seguro de que quieres borrar este Foro?'))
                {
                    window.location=url;
                }
                else
    ...
    <body>
        ...
        <br />
        <h1 class="foro" align="center"> FORO </h1>
        <br />
        <h2 class="hilos" align="center"><i> Hilos del Foro </i></h2>
        <br />  


        <table align="center" class="table table-hover margen"> 
            <tr align="center" class="info">
                <td></td>
                <td><h4 align="center"> Tema </h4></td>
            ...
            <tr class="warning">
                <td></td>
                <td> <a href="Servlet?operacion=ver&id=<% out.print(registros.get(i).getId());%>">
                        <% out.println(registros.get(i).getNombre());%></a></td>
                <td> <% out.println(registros.get(i).getFecha());%></td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>

                <%
                    int idHilo = registros.get(i).getId();
