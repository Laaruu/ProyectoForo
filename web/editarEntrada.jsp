<%-- 
    Document   : editarEntrada
    Created on : 19-nov-2012, 18:30:53
    Author     : vesprada
--%>
...
<%
    ...
    /* Declaramos la variables que editaremos */
    String titulo = "";
    String contenido = "";
    ...
    /* Recogemos el id del hilo donde nos encontramos y la id de la entrada que vamos a editar */
    String idHiloE = request.getParameter("idHilo");
    ...
    request.setAttribute("datos1", idHilo);
    request.setAttribute("datos2", registros2);
    int size2 = registros2.size();

    for (int i = 0; i < size2; i++) {
        titulo = registros2.get(i).getTitulo();
        contenido = registros2.get(i).getContenido();
    }
...
<html>
        ...
        <script>
            ...
            function valida(F) {  
                ...
                if( vacio(F.titulo.value) == false ) {  
                    alert("No puedes dejar el título del tema en blanco.")  
                    return false  
                } 
                
                if( vacio(F.contenido.value) == false ) {  
                    alert("No puedes dejar el comentario en blanco.")  
                    return false  
                } else {
                    return true  
                }
    ...
    <body>
        ...
        <br />
        <div>
            <img src="img/lapiz.jpg" class="edit"/>	
        </div>
        <div id="cuerpo2" class="span3">
            <fieldset>
                <div>
                    <legend>&nbsp; &nbsp;  Edita tu comentario </legend>
                    <form action="EditarEntrada" method="post" onSubmit="return valida(this);"> 
                        ...
                        <input type="submit" value="Editar Comentario" class="float"/>
                    </form>
